...
int main()
{
    ...
    std::cout << "please input t_steps, x_dim, y_dim, z_dim: " << std::endl;

    std::cin >> t_steps >> x_dim >> y_dim >> z_dim;
    ...
    std:: cout << "please input the data(sequence sorted by x, y, z): " << std::endl;
    ...
    std::cout << "down! starting calculate" << std::endl;
